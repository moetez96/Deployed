...
const jobTitleFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/tanitjobs/tanitJobsTitle.json")
);
const locationAndCompanyFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/tanitjobs/locationAndCompany.json")
);

const tanitLinksFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/tanitjobs/TJLinks.json")
);
...
const indeedJobTitleFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/indeed/indeedJobsTitle.json")
);

const indeedDescriptionFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/indeed/indeedDescription.json")
);

const indeedRateFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/indeed/indeedRate.json")
);

const indeedImageseFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/indeed/indeedImages.json")
);

const indeedLinkFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/indeed/indeedLinks.json")
);
...
const edxTitlesFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/edx/edxTitles.json")
);

const edxDescriptionFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/edx/edxDescription.json")
);

const edxCertificateFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/edx/edxCertificate.json")
);

const edxNumberOfCoursesFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/edx/edxNumberOfCourses.json")
);

const edxLinksFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/edx/edxLinks.json")
);
...
const freecourseTitleJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/freecourse/freecourseTitle.json")
);

const freecourseImagesFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/freecourse/freecourseImages.json")
);

const freecourseDescriptionFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/freecourse/freecourseDescription.json")
);

const freecourseDateFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/freecourse/freecourseDate.json")
);

const freecourseLinksFromJson = fs.readFileSync(
    path.resolve(__dirname, "../../data/freecourse/freecourseLinks.json")
);
