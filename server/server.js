...
//Connect Database
//connectDB();
mongoose.connect(process.env.DB_URI || require('./config/default.json').mongoURI, {
    useNewUrlParser: true
});
const app = express();
const server = http.createServer(app);
var allowedOrigins = "http://localhost:* http://127.0.0.1:*";
var paths = "/*"; // you need this if you want to connect to something other than the default socket.io path
